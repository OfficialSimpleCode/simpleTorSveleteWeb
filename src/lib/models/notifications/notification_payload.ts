...
enum EnterAction {
  ...
  const enterActionToStr: { [key in EnterAction]: string } = {
  ...
  const enterActionFromStr: { [key: string]: EnterAction } = {
  ...
  export default class NotificationPayload {
    ...
    static fromJsonStr(jsonStr: string): NotificationPayload {
      ...
      return new NotificationPayload({
        ...
        paymentRequestData: json.paymentRequestData
          ? PaymentRequestNotificationPayload.fromJsonStr(
    ...
    get currentShopIcon(): IconData  | undefined {
      ...
      if (this.invoiceData !== undefined && this.invoiceData.shopIcon.isNotEmpty) {
      ...
      if (this.bookingData !== undefined && this.bookingData.shopIcon.isNotEmpty) {
