...
interface MaleToFemaleMap {
  [key: string]: string;
}

const maleToFemaleMap: MaleToFemaleMap = {
  "אתה בטוח": "את בטוחה",
  "אתה יכול": "את יכולה",
  "דרג ": "דרגי ",
  "אתה ": "את ",
...
const genderToStr: { [key in Gender]: string } = {
    [Gender.male]: 'male',
    [Gender.female]: 'female',
    [Gender.anonymous]: 'anonymous',
};

const genderFromStr: { [key: string]: Gender } = {
  'male': Gender.male,
  'female': Gender.female,
  'anonymous': Gender.anonymous
};

const genderColors: { [key in Gender]: string } = {
  [Gender.male]: 'blue',
  [Gender.female]: 'pink',
