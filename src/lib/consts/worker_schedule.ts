enum Religion {
  ...
  const religionToStr: Record<Religion, string> = {
    [Religion.muslim]: "muslim",
    [Religion.christian]: "christian",
    [Religion.jewish]: "jewish",
  };
  
  const religionFromStr: Record<string, Religion> = {
    "muslim": Religion.muslim,
    "christian": Religion.christian,
    "jewish": Religion.jewish,
  };
  
  const holidays: Record<Religion, Record<string, string>> = {
    [Religion.christian]: {
  ...
  const eventFilterTypeToStr: Record<EventFilterType, string> = {
  ...
  const eventFilterTypeToIcon: Record<EventFilterType, string> = {
  ...
  const eventFilterWithCountersTypeToStr: Record<EventFilterType, string> = {
    [EventFilterType.onHold]: "waitingsForApproval",
    [EventFilterType.needCancel]: "waitingsForCancel",
    [EventFilterType.waitingList]: "waitingList",
    [EventFilterType.withDebts]: "withDebts"
  ...
  const typesNeedRecurrence = new Set([
