...
<section id="service-step" class="w-full flex flex-col items-center gap-12">
    ...
    >
        <div
            class="w-full sm:w-[40%] flex flex-row items-center justify-between"
        >
            {$_("chooseMulti")}
            <input
            ...
            {#each subject.treatments as [name, service]}
                ...
                >
                    <button
                        ...
                        on:click={() =>
                            serviceChosen(service, selectedServices)}
                    >
                        ...
                        <div class="flex items-center h-full">
                            <div
                                class="divider divider-horizontal border-black"
                            />
                            <div>
                    ...
                    {#if serviceCount(service, selectedServices) > 0}
                        <div class="join self-end">
                            <button
                                ...
                                on:click={() =>
                                    (selectedServices = removeService(
                                        service,
                                        selectedServices,
                                    ))}
                            >
