    ...
    <div class="grid pt-8 md:gap-16 md:grid-cols-2 gap-10">
      <div>
        ...
        >
          ...
          <p>
            המערכת שלנו עוצבה בצורה נוחה ופשוטה לשימוש שלא תשאיר ללקוחות שלך
            מקום להסתבך.
          </p>
          <p>
      ...
      <div>
        ...
        >
          <p>
            ...
            המערכת שלנו נבתנה על בסיס ההבנה הזו.
          </p>

          <p>
            המערכת שלנו בנויה בצורה דינאמית הנותנת לך ארגז כלים רחב שמאפשר לך
            להשיג את הדברים שהעסק שלך צריך
          </p>
