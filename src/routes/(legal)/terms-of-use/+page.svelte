  ...
  <div class="flex flex-col items-center pb-10">
    <section class="text-start mx-6 max-w-[850px]">
      ...
      <h2 class="py-5 opacity-70">
        ברוכים הבאים למערכת Simple Tor, המערכת נועדה להקל על בעלי העסקים
...
לאפליקציה Simple Tor בחנויות האפלקציות השונות, על כל חלקיה, כל העמודים השונים תחת כתובת דומיין או האפליקציה, לתוכן האפליקציה מכל סוג ומין שהוא, לרבות כל המידע והתוכן הכלול באפליקציה, בין אם הוא גלוי למשתמשים ובין אם לאו. 
...
`,
      ...
      <!-- contact -->
      <TitleAndBody title="קישורים לאתרים אחרים (Links)">
        <p>
      ...
      <TitleAndBody title="כפיפות למדיניות הפרטיות">
        <p>
          {`סימפל קוד מייחסת חשיבות רבה לשמירה על פרטיות המשתמשים במערכת. מדיניות הפרטיות של סימפל קוד מפורטת באתר זה והיא מהווה חלק בלתי נפרד מתנאי שימוש אלה. הואיל ומדיניות הפרטיות יכולה להשתנות מעת לעת, מומלץ למשתמש לחזור ולקרוא את מסמך מדיניות הפרטיות מפעם לפעם. השימוש במערכת מהווה אף הסכמה ל`}
          <a
            href={`${base}/privacy`}
      ...
      <TitleAndBody title="הוראות שונות" contentAsUl={true}>
        <ul class="space-y-4">
          <p class="py-1">
          ...
          <p class="py-1">
            {`10.7 כל שאלה או בעיה הקשורה למערכת או לתנאי השימוש בה וכן בכל הצעה לשיפור או המלצה יש להפנות לסימפל קוד ע"י`}
            <button
              on:click={openContactUs}
              class="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline"
              >{`דרכי ההתקשרות`}</button
            >
            {`שנמצאים ב`}
            <a
              href={`${base}/`}
